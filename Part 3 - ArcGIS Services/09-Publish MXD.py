...
mxdPath = r"D:\EGT16\Part 3 - ArcGIS Services\Windmills.mxd"
sdDraftFile =  r"D:\EGT16\Part 3 - ArcGIS Services\Windmills.sddraft"
sdFile = r"D:\EGT16\Part 3 - ArcGIS Services\Windmills.sd"
...
def GetLogger():
    global _logger
    if _logger == None:
        fh = logging.FileHandler(r"D:\EGT16\Part 3 - ArcGIS Services\Logs\09-publishmxd_{}.log".format(datetime.datetime.now().strftime('%Y%m%d_%H%M%S')))
